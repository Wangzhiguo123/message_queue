...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'openTopic',
        component: () => import('@/views/management/system/openTopic'),
        name: 'openTopic',
        meta: {
          title: '开放主题',
          noCache: true,
      ...
      // {
      //   path: 'system',
      //   component: () => import('@/views/management/system/system'),
      //   name: 'Application',
      //   meta: {
      //     title: '主题管理',
      //     noCache: true,
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'application',
        component: () => import('@/views/management/application/application'),
        name: 'Application',
        meta: {
          title: '应用程序管理',
          noCache: true,
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'authorization',
        component: () => import('@/views/management/authorization/authorization'),
        name: 'Authorization',
        meta: {
          title: '主题授权',
          noCache: true,
      ...
      { 
        path: 'application',
        component: () => import('@/views/management/authorization/application'),
        name: 'Application',
        meta: {
          title: '应用程序授权',
          noCache: true,
